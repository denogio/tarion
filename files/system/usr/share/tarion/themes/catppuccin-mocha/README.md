...
To install this theme, simply use the tarion-theme-install command:

```bash
tarion-theme-install https://github.com/Luquatic/tarion-catppuccin-dark
```

or

`Tarion menu > Install > Style > Theme` and use the following link:

`https://github.com/Luquatic/tarion-catppuccin-dark
`
